...
Listings.controller('ListingsController', function ($scope, $filter,
    ownerListings,
    ...
    $scope.editListing = function (item) {
        ownerListings.get({ id: item.Id },
          function (data) {
              ...
              CKEDITOR.instances.Description.insertHtml(data.Description);              
              ...
              $.each(jQuery.parseJSON(data.Images), function (imageIndex, imageItem) {
                  $scope.fileList.push({
                      Id: ($scope.fileList.length + 1), File: imageItem.File, Size: imageItem.size
                  });
    ...
    function init() {     
      ...
      //  $scope.roomTypes = [{ Id: 1, Type: "Single" }, { Id: 2, Type: "Double" }, { Id: 3, Type: "Twin" }, { Id: 4, Type: "Other" }];
    ...
    function help() {
        ...
        $scope.help_theatres = "Use this section to add the distances to your local theatres. Select the 'Name' of the theatre, the 'Town' the theatre is in and finally the 'Distance' eg '10 mins' then teh mode of 'Transport'. You can add multiple modes of transport for each theatre. Say '10 mins walking', '5 mins by car'.";
